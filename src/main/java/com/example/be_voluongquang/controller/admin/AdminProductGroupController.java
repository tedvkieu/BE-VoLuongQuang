...
public class AdminProductGroupController {
    ...
    public ResponseEntity<ProductGroupResponseDTO> restoreProductGroup(@PathVariable String id) {
        return ResponseEntity.ok(productGroupService.restoreProductGroup(id));
    }
}
