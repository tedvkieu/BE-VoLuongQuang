...
import com.example.be_voluongquang.security.ApiAccessRules;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtAuthenticationFilter)
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(ApiAccessRules.PUBLIC_PATTERNS).permitAll()
                        ...
                        .requestMatchers(ApiAccessRules.AUTHENTICATED_PATTERNS).authenticated()
